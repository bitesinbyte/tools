      ...
      <Stack spacing={2.5}>
        ...
        >
          ...
          <Tooltip title="Copy to clipboard">
            <IconButton aria-label="Copy to clipboard" size="small" onClick={handleCopy} disabled={!value} sx={{ color: 'text.secondary' }}>
              <ContentCopyIcon fontSize="small" />
            </IconButton>
          </Tooltip>
          <Tooltip title="Clear">
            <IconButton aria-label="Clear JSON" size="small" onClick={handleClear} disabled={!value} sx={{ color: 'text.secondary' }}>
          ...
          <Tooltip title="Download JSON file">
            <IconButton
              aria-label="Download valid JSON"
              size="small"
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, alignItems: 'center' }}>
            {stats.valid ? (
              <>
                ...
                {(stats.type === 'Array' || stats.type === 'Object') && (
                  <Chip
